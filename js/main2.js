document.getElementById("Form_pesoIdeal").addEventListener("submit", function (event) { 
    ...
    const edad1 = document.getElementById("edad1").value; // Obtener el valor ingresado en el campo edad
    ...
    console.log("Sexo: ",sexo,"Edad:", edad1, "Peso Actual: ", pesoActual,"Altura: ", altura); // Mostrar los valores obtenidos en la consola
    ...
    mensaje = `<strong>Resultado:</strong><br>Edad:${edad1} años<br>Peso actual: ${pesoActual} kg<br>Altura:${altura} cm <br>IMC: ${imc.toFixed(2)} ${mensajeImc} <br> Peso Ideal: <span class="badge text-bg-info">${pesoIdeal} kg</span> <br> Deberias perder:<span class="badge text-bg-danger">${diferenciaPeso.toFixed(2)} Kg</span> `;
